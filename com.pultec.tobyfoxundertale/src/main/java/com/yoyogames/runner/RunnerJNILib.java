...
import com.pultec.tobyfoxundertale.RunnerActivity;

import com.pultec.tobyfoxundertale.RunnerKeyboardController;
import com.pultec.tobyfoxundertale.DemoGLSurfaceView;
import com.pultec.tobyfoxundertale.DemoRenderer;
import com.pultec.tobyfoxundertale.Gamepad;

import com.pultec.tobyfoxundertale.R;
import com.pultec.tobyfoxundertale.ISocial;
import com.pultec.tobyfoxundertale.IAdExt;
...
//    public static native void OnKakaoMessageResult(int _id, int _statusCode,String _msg);
 ...
 //   public static native void OnKakaoFriendsLoaded(String[] friends,String[] appfriends);
    ...
    public static void PlayMP3( String _mp3, int _loop ) {
    	...
    	try {
    		Class resRaw = Class.forName("com.pultec.tobyfoxundertale.R$raw");    		
	...
	*/
	...
	//	Log.i("yoyo","Java side attempting to call extension function " + methodname + " on class " + classname); 
		try{
			...
			try{
				ReqClass = Class.forName("com.pultec.tobyfoxundertale."+classname);
			}
			catch (ClassNotFoundException e)
			{
				Log.i("yoyo","Extension Class not found: " + "com.pultec.tobyfoxundertale."+classname + " attempting to call " + methodname);
			}
